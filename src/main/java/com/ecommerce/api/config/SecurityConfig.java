    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, AuthenticationProvider authenticationProvider)
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    http.requestMatchers(HttpMethod.GET, "api/user/**").hasAnyRole("ADMIN", "SELLER", "CLIENT");
                    http.requestMatchers(HttpMethod.POST, "api/user/**").permitAll();
                    http.requestMatchers(HttpMethod.PUT, "api/user/**").hasAnyRole("ADMIN", "SELLER", "CLIENT");
                    http.requestMatchers(HttpMethod.DELETE, "api/user/**").hasAnyRole("ADMIN");
                    http.requestMatchers(HttpMethod.GET, "api/order/**").hasAnyRole("ADMIN", "SELLER", "CLIENT");
                    http.requestMatchers(HttpMethod.POST, "api/order/**").hasAnyRole("ADMIN", "SELLER", "CLIENT");
                    http.requestMatchers(HttpMethod.PUT, "api/order/**").hasAnyRole("ADMIN");
                    http.requestMatchers(HttpMethod.DELETE, "api/order/**").hasAnyRole("ADMIN");
                    http.requestMatchers(HttpMethod.GET, "api/cart/**").permitAll();
                    http.requestMatchers(HttpMethod.POST, "api/cart/**").hasAnyRole("ADMIN", "CLIENT", "SELLER");
                    http.requestMatchers(HttpMethod.PUT, "api/cart/**").hasAnyRole("ADMIN", "CLIENT", "SELLER");
                    http.requestMatchers(HttpMethod.DELETE, "api/cart/**").hasAnyRole("ADMIN");
                    http.requestMatchers(HttpMethod.GET, "api/marker/**").permitAll();
                    http.requestMatchers(HttpMethod.POST, "api/marker/**").hasAnyRole("ADMIN");
                    http.requestMatchers(HttpMethod.PUT, "api/marker/**").hasAnyRole("ADMIN");
                    ...
                    http.requestMatchers(HttpMethod.POST, "api/payment/**").hasAnyRole("ADMIN", "SELLER", "CLIENT");
                    ...
                    http.requestMatchers(HttpMethod.POST, "api/permission/**").hasAnyRole("ADMIN");
                    http.requestMatchers(HttpMethod.PUT, "api/permission/**").hasAnyRole("ADMIN");
