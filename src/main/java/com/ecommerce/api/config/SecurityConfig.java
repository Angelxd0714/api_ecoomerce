    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, AuthenticationProvider authenticationProvider)
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    http.requestMatchers(HttpMethod.POST, "api/order/**").hasAnyRole("ADMIN", "CLIENT", "SELLER");
                    http.requestMatchers(HttpMethod.PUT, "api/order/**").hasAnyRole("ADMIN", "CLIENT", "SELLER");
