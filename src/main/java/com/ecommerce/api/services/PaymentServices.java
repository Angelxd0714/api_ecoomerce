...
public class PaymentServices implements CrudPayments {
        ...
        public void createPayment(PaymentRequest paymentRequest) {
                ...
                OrdersRequest order = OrdersRequest.builder()
                                ...
                                .productRequest(productRequests.stream().map(ProductRequest::getId)
                                                .collect(Collectors.toSet()))
                                .build();
        ...
        public List<PaymentsDTO> findByPaymentMethod(String paymentMethod) {
                return repositoryPayment.findAll().stream().filter(x -> x.getPaymentMethod().equals(paymentMethod))
                                .map(x -> PaymentsDTO.builder()
                                                .id(x.getId())
                                                .orderId(x.getOrderId().getId())
                                                .userId(x.getUserId().getId())
                                                .paymentMethod(x.getPaymentMethod())
        ...
        public List<PaymentsDTO> findByPaymentStatus(String paymentStatus) {
                return repositoryPayment.findAll().stream().filter(x -> x.getPaymentStatus().equals(paymentStatus))
                                .map(x -> PaymentsDTO.builder()
                                                .id(x.getId())
                                                .orderId(x.getOrderId().getId())
                                                .userId(x.getUserId().getId())
        ...
        public List<PaymentsDTO> findByPaymentDate(LocalDate paymentDate) {
                return repositoryPayment.findAll().stream().filter(x -> x.getPaymentDate().equals(paymentDate))
                                .map(x -> PaymentsDTO.builder()
                                                .id(x.getId())
                                                .orderId(x.getOrderId().getId())
                                                .userId(x.getUserId().getId())
        ...
        public List<PaymentsDTO> findByOrderId(Long orderId) {
                Orders orders = Orders.builder()
                                .id(orderId)
                                .build();
                return repositoryPayment.findAll().stream().filter(x -> x.getOrderId().equals(orders))
                                .map(x -> PaymentsDTO.builder()
                                                .id(x.getId())
                                                .orderId(x.getOrderId().getId())
                                                .userId(x.getUserId().getId())
